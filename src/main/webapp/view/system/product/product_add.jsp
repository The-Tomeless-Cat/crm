...
<body>
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form action="<%=basePath%>productController/AddProduct.do"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="" name="productMoney"
							data-validate="required:请输入金额" />
						<div class="tips"></div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="" name="productDsc"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="" name="pruductKucun"
